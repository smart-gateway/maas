...
Puppet::Functions.create_function(:'maas::machine_get_interfaces_on_default_fabric') do
  dispatch :machine_get_interfaces_on_default_fabric do
    param 'String', :server
  ...
  def machine_get_interfaces_on_default_fabric(server, consumer_token, auth_token, auth_signature, system_id)
